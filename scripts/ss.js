...
function ChiefSlider(t,i){var e="string"==typeof t?document.querySelector(t):t;
for(var s in this._$root=e,
    ...
    this._minOrder=0,
    this._maxOrder=0,this._$itemWithMinOrder=null,
    ...
    o=Math.round(n/a);this._widthItem=a,
    this._widthWrapper=n,
    this._itemsInVisibleArea=o,
    this._transformStep=100/o;
    for(var h=0,_=r.length;
        h<_;h++)r[h].dataset.index=h,
        r[h].dataset.order=h,
...
function r(t){
    if(this._hasSwipeState){
        ...
        e>50?(this._direction="next",this._move()):e<-50&&(
...
t.addEventListener("click",function(t){
    ...
    this._move();else if(
        i.dataset.slideTo){
            ...
            this._moveTo(e)}
            this._config.loop&&this._autoplay()}.bind(this)),
            t.addEventListener("mouseenter",
            function(t){this._autoplay("stop")}.bind(this)),
            t.addEventListener("mouseleave",
            function(t){this._autoplay()}.bind(this)),
            ...
            {this._balancingItemsFlag||(this._balancingItemsFlag=!0,window.requestAnimationFrame(this._balancingItems.bind(this)))}.bind(this)),
            i.addEventListener("transitionend",function(){this._balancingItemsFlag=!1}.bind(this))),
            e.swipe&&(t.addEventListener("touchstart",s.bind(this)),t.addEventListener("mousedown",
            s.bind(this)),document.addEventListener("touchend",
            r.bind(this)),document.addEventListener("mouseup",r.bind(this))),
            t.addEventListener("dragstart",function(t){t.preventDefault()}.bind(this)),
            document.addEventListener("visibilitychange",
            function(){"hidden"===document.visibilityState?
            this._autoplay("stop"):"visible"===document.visibilityState&&this._config.loop&&this._autoplay()}.bind(this))},
            ChiefSlider.prototype.__refreshExtremeValues=function(){var t=this._$itemList;this._minOrder=+t[0].dataset.order,
                this._maxOrder=this._minOrder,this._$itemByMinOrder=t[0],
                ...
                {var s=t[i],r=+s.dataset.order;
                    r<this._minOrder?(
                        ...
                        this._minTranslate=+s.dataset.translate):
                        r>this._maxOrder&&(this._maxOrder=r,this._$itemByMaxOrder=s,
                            this._maxTranslate=+s.dataset.translate)
                }
            },
            ChiefSlider.prototype._balancingItems=function()
            {if(this._balancingItemsFlag){var t,i=this._$wrapper.getBoundingClientRect(),
                e=i.width/this._itemsInVisibleArea/2,
                s=this._$itemList.length;
                if("next"===this._direction){
                    var r=i.left,a=this._$itemByMinOrder;
                    t=this._minTranslate,
                    a.getBoundingClientRect().right<r-e&&(a.dataset.order=this._minOrder+s,t+=100*s,
                    a.dataset.translate=t,
                    a.style.transform="translateX(".concat(t,"%)"),
                    this.__refreshExtremeValues())}else{var n=i.right,
                        o=this._$itemByMaxOrder;t=this._maxTranslate,
                        o.getBoundingClientRect().left>n+e&&(o.dataset.order=this._maxOrder-s,t-=100*s,
                            o.dataset.translate=t,
                            o.style.transform="translateX(".concat(t,"%)"),
                            this.__refreshExtremeValues())}requestAnimationFrame(this._balancingItems.bind(this))}
            },
            ChiefSlider.prototype._setActiveClass=function(){
                for(var t=this._activeItems,
                    i=this._$itemList,e=0,s=i.length;e<s;e++){
